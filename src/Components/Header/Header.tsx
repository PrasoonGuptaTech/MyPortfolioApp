...
function Header() {
  ...
  const onGithubPressHandler = () => Linking.openURL('https://github.com/PrasoonGuptaTech');
  return (
    <>
      ...
      <Pressable style={styles.rowView} onPress={onEmailPressHandler}>
        <Image source={require('../../Assets/Images/EmailIcon.png')} style={styles.emailLogo} />
      ...
      <View style={styles.rowView}>
        <Pressable style={styles.rowSeperation} onPress={onLinkedinPressHandler}>
          <Image
        ...
        <Pressable style={styles.rowSeperation} onPress={onGithubPressHandler}>
          <Image source={require('../../Assets/Images/GithubIcon.png')} style={styles.emailLogo} />
        </Pressable>
      </View>
    </>
  );
